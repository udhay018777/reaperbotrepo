...
def set_about_bio(bot: Bot, update: Update):
    ...
    if message.reply_to_message:
        ...
        if user_id == message.from_user.id:
            message.reply_text("Hehe, I can`t allow you to set your own bio! You're at the mercy of others sudoers here...")
            return
            ...
            message.reply_text("You ain't setting my master`s bio LMAO.")
            return
