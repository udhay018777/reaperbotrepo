...
from haruka import dispatcher, OWNER_ID, SUDO_USERS, WHITELIST_USERS, SUPPORT_USERS
from haruka.modules.helper_funcs.extraction import extract_user_and_text, extract_user
from haruka.modules.log_channel import gloggable

BLACKLISTWHITELIST = [OWNER_ID] + SUDO_USERS + WHITELIST_USERS + SUPPORT_USERS
