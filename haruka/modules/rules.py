...
def send_rules(update, chat_id, from_pm=False):
    ...
    if from_pm and rules:
        ...
        bot.send_message(user.id, "The group admins haven't set any rules for this chat yet. "
                                  "This probably means this chat is lawless! Do whatever you want XD")
    elif rules:
...
def set_rules(bot: Bot, update: Update):
    ...
    if len(args) == 2:
        ...
        update.effective_message.reply_text("Successfully set rules for this group! Now make sure everyone follows them")
